...
function getFullUrl(req) {
    return req.headers["baseurl"] + req.originalUrl;
...
Nuts.prototype.serveAsset = function(req, res, version, asset) {
    ...
    console.log("calling serveAsset : " + fullUrl + "\n")
    var that = this;
...
Nuts.prototype.onDownload = function(req, res, next) {
    var fullUrl = getFullUrl(req);
    console.log("calling onDownload : " + fullUrl + "\n")
    var that = this;
...
Nuts.prototype.onUpdateRedirect = function(req, res, next) {
    var fullUrl = getFullUrl(req);
    console.log("calling onUpdateRedirect : " + fullUrl + "\n")
    Q()
    .then(function() {
...
Nuts.prototype.onUpdate = function(req, res, next) {
    var that = this;
    var fullUrl = getFullUrl(req);
    console.log("calling onUpdate : " + fullUrl + "\n")
    var platform = req.params.platform;
    var channel = req.params.channel || '*';
    ...
    .then(function(versions) {
        ...
        console.log("serving version : " + latest.tag);
